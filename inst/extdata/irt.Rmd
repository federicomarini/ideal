...
if(!is.null(values$res_obj)) {
  ...
  p2 <- ggplot(res_df, aes_string("log2FoldChange")) +
...
<!-- `ideal` guides the user in exploring the Principal Components of the data,  -->
...
`ideal` is currently maintained by Federico Marini at the IMBEI (www.imbei.uni-mainz.de).
